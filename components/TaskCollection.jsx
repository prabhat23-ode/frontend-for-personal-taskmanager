  ...
  return (
    <>
      ...
      <div className="mx-4 my-6 max-w-lg text-[rgb(250,235,215)] relative">
        {/* Group tasks by importance for the current user */}
        {[
          { key: "very-important", label: "Very Important" },
          { key: "important", label: "Important" },
          { key: "not-so-important", label: "Not so important" },
        ].map((group) => {
          const items = task.filter((t) => (t.importance || "not-so-important") === group.key);
